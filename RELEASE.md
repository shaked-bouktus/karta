...
- `github.com/run-ai/karta`
- `github.com/run-ai/karta/cli`
- `github.com/run-ai/karta/operator`
...
```bash
go mod edit -modfile=cli/go.mod -require=github.com/run-ai/karta@v1.2.3
go mod edit -modfile=operator/go.mod -require=github.com/run-ai/karta@v1.2.3
